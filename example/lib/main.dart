...
import 'package:arkit_plugin_example/camera_distance_page.dart';
...
class App extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final samples = [
      Sample(
        'Distance Between Plane and Camera',
        'distance between plane and camera.',
        Icons.camera_alt,
            () => Navigator.of(context)
            .push<void>(MaterialPageRoute(builder: (c) => CameraDistancePage())),
      ),
      Sample(
        'Hello World',
